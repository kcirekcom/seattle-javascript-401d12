...
## What is NodeJS?
  ...
  * **Basics of Working in NodeJS**
    ...
    * **demo:**  simple file creation and execution
      * [hello-world](/01-modular_patterns_and_testing/lecture/demo/hello-world)
...
## Modular Patterns in NodeJS
  ...
  * **Introduction to the `module.exports` Pattern**
    ...
    * **demo:** hello world demo, modularized
      * [hello-world-modularized](/01-modular_patterns_and_testing/lecture/demo/hello-world-modularized)
    * **demo:** hello world demo, modularized, and with multiple methods
      * [hello-world-module-methods](/01-modular_patterns_and_testing/lecture/demo/hello-world-module-methods)
  ...
  * **Working with MochaJS**
    ...
    * difference between unit, e2e, and integration testing
      ...
      * **demo:** basic module testing
        * [hello-world-module-tests](/01-modular_patterns_and_testing/lecture/demo/hello-world-module-tests)
